...
<div class="container">
	...
	<div class="searchuserdiv ope">
		<ul>
			...
			<li class="important">操作资金：
			<input name="money" type="text" id="money"/><br/>
			重要提示：输入的资金数，<b>正数(1000)</b>为向账户增加1000元，<b>负数（-1000）</b>
			为向账户减少1000元，精确到小数点两位数</li>
			<li>操作备注：<br/>
			<textarea id="memo" name="memo"></textarea></li>
			<li><input id="caiwuok" type="button" value="确定"/></li>
			<li class="tip">操作提示 : 
			<span id="systemtip">输入的资金数，正数(1000)为向账户增加1000元，
